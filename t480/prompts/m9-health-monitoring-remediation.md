...
3. If the T480 checkout is dirty, use the approved `repository_snapshot_and_update` operation. It creates and verifies a timestamped tracked-worktree patch snapshot outside the checkout before resetting tracked files; it does not clean untracked or ignored operational files.
