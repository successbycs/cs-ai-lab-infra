...
file_size="$(docker compose -f /home/chris/projects/cs-ai-lab-infra/compose.yaml exec -T n8n sh -lc 'test -s /home/node/.n8n-files/n8n-live-test.txt && wc -c < /home/node/.n8n-files/n8n-live-test.txt' </dev/null)"
file_sha256="$(docker compose -f /home/chris/projects/cs-ai-lab-infra/compose.yaml exec -T n8n sh -lc 'sha256sum /home/node/.n8n-files/n8n-live-test.txt | head -c 64' </dev/null)"
